...
read_file -top ALUFormal -format sverilog -sva -vcs {-full64 -sverilog -f /mnt/zen-core/tb/tb-alu/chisel-tb/build/filelist.f +incdir+/mnt/zen-core/tb/tb-alu/chisel-tb/build}
